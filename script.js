...
function drawMarkersOnMap() {
    ...
    reportsData.forEach((r, index) => {
        ...
        const gMapsUrl = `http://googleusercontent.com/maps.google.com/maps?daddr=${r.lat},${r.lng}&travelmode=walking`;
...
function openSelectionPopup(latlng) {
    ...
    <div style="width: 260px; font-family: sans-serif;">
      ...
      <div style="display: flex; flex-direction: column; gap: 5px;">
        ...
        <button onclick="finalizeReport(${latlng.lat}, ${latlng.lng}, 'Aufzug vorhanden', '#27AE60')" style="background:#27AE60; color:white; border:none; padding:10px; border-radius:5px; cursor:pointer;">🛗 Aufzug OK</button>
